...
This USLCI Database release is Version 1 of the USLCI summer 2026 release (v1.2026-06.0). This USLCI database version is available on the [NREL USLCI repo](https://www.lcacommons.gov/lca-collaboration/) of the [Federal LCA Commons Collaboration Server](https://www.lcacommons.gov) (FLCAC) as well as via the [USLCI Release Downloads](/docs/release_info/release-downloads.md) page of this GitHub site.
