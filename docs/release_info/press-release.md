...
## 2026 Summer Quarter (June 30)
This USLCI Database release is Version 1 of the USLCI summer 2026 release (v1.2026-06.0). This USLCI database version is available on the [NLR USLCI repo](https://www.lcacommons.gov/lca-collaboration/) of the [Federal LCA Commons Collaboration Server](https://www.lcacommons.gov) (FLCAC) as well as via the [USLCI Release Downloads](/docs/release_info/release-downloads.md) page of this GitHub site.

### Overview of 1.2026-06.0 Changes:
- Electricity Baseline 2023 Library. The new version of the [Electricity Baseline repository](https://www.lcacommons.gov/lca-collaboration/Federal_LCA_Commons/US_electricity_baseline/datasets) was added to USLCI as a library. All electricity providers were updated to use the 2023 electricity data. This release also includes new residual mix datasets for use. In a residual mix, the electricity from renewable sources which is claimed via other mechanisms (e.g., Renewable Energy Credits) is removed from the available mix. As a reminder, [we have a list of frequently asked questions](https://flcac-admin.github.io/FLCAC-docs/elci-faq/) related to the Electricity Baseline. 
- Natural Gas Supply Chain. New natural gas supply chain data was added into USLCI from Argonne National Laboratory’s [GREET model](https://greet.anl.gov/index.php). **The pre-existing natural gas supply chain data will be phased out over the next quarter and GREET will become the primary source of natural gas data in the next USLCI release.** In the GREET default, methane emissions in the natural gas supply chain use a hybrid of bottom-up and top-down approaches for estimating methane leakage, see [Burnham 2024](https://greet.anl.gov/publication-update_ng_2024). USLCI follows the hybrid default approach from GREET, but users can use the 'CH4_LEAKAGE_METHOD' global parameter in these processes to implement the bottom-up approach instead.
- Beef and Swine Production. Processes related to Beef (8) and Swine (48) production have been incorporated into the USLCI. Originally developed by the University of Arkansas, these datasets have existed on the FLCAC historically but did not use the Federal Elementary Flow List and were not integrated with other repositories. Outside of flow mapping and linking to upstream supply chains in the USLCI, no significant data or metadata updates were made. **The legacy repositories ([Beef](https://www.lcacommons.gov/lca-collaboration/University_of_Arkansas/Beef_production/datasets), [Swine](https://www.lcacommons.gov/lca-collaboration/University_of_Arkansas/Swine/datasets)) will remain on the FLCAC for the time being, but will be removed in the future.**
...
The version of the Electricity Baseline that is currently a library in USLCI has been adapted from the [public version of the repository](https://www.lcacommons.gov/lca-collaboration/Federal_LCA_Commons/US_electricity_baseline/datasets). When you download USLCI from lcacommons.gov, the library will automatically download and connect to the database.

### Change Log, Versioning, &amp; Data Submission

Please see the complete [Change Log](/docs/release\_info/change-log.md) for details of all summer 2026 updates. Additionally, please note that current and deleted datasets are always also available in an archive managed by NLR (wherein current and previous USLCI database versions are available) at the [USLCI Downloads Page](/docs/release\_info/release-downloads.md). Finally, please see the [FLCAC Submission Handbook](https://flcac-admin.github.io/FLCAC-docs/datasubmissionhandbook) and/or contact the contact the [USLCI Data Curator](mailto:uslci@erg.com) if you have any data/metadata publishing goals for the next September 2026 fall release date. We look forward to hearing from you soon.



## 2026 Spring Quarter (March 31)
This USLCI Database release is Version 1 of the USLCI spring 2026 release (v1.2026-03.0). This USLCI database version is available on the [NREL USLCI repo](https://www.lcacommons.gov/lca-collaboration/) of the [Federal LCA Commons Collaboration Server](https://www.lcacommons.gov) (FLCAC) as well as via the [USLCI Release Downloads](/docs/release_info/release-downloads.md) page of this GitHub site.

### Overview of 1.2026-03.0 Changes:
...
Please see the complete [Change Log](/docs/release\_info/change-log.md) for details of all spring 2026 updates. Additionally, please note that current and deleted datasets are always also available in an archive managed by NREL (wherein current and previous USLCI database versions are available) at the [USLCI Downloads Page](/docs/release\_info/release-downloads.md). Finally, please see the [FLCAC Submission Handbook](https://flcac-admin.github.io/FLCAC-docs/datasubmissionhandbook) and/or contact the contact the [USLCI Data Curator](mailto:uslci@erg.com) if you have any data/metadata publishing goals for the next June 2026 spring release date. We look forward to hearing from you soon.

## 2025 Winter Quarter Version 2 (March 17)
This USLCI Database release is Version 2 of the USLCI winter 2025 release (v1.2025-12.1). This USLCI database version is available on the [NREL USLCI repo](https://www.lcacommons.gov/lca-collaboration/) of the [Federal LCA Commons Collaboration Server](https://www.lcacommons.gov) (FLCAC) as well as via the [USLCI Release Downloads](/docs/release_info/release-downloads.md) page of this GitHub site.
...
### Overview of 1.2025-09.0 Changes:

Overview of USLCI 2025 Fall Quarter Changes:
- Added industrial wastewater treatment processes
...
Please see the complete [Change Log](/docs/release\_info/change-log.md) for details of all fall 2025 updates. Additionally, please note that current and deleted datasets are always also available in an archive managed by NREL (wherein current and previous USLCI database versions are available) at the [USLCI Downloads Page](/docs/release\_info/release-downloads.md). Finally, please see the [FLCAC Submission Handbook](https://flcac-admin.github.io/FLCAC-docs/datasubmissionhandbook) and/or contact the contact the [USLCI Data Curator](mailto:uslci@erg.com) if you have any data/metadata publishing goals for the next December 2025 winter release date. We look forward to hearing from you soon.
...
- Added nine new wastewater treatment pathways which include wastewater treatment, effluent release, sludge hauling and landfill processes, and biogas flaring (28 processes total). These datasets were prepared for the FLCAC by ERG, based on [prior published research](https://www.epa.gov/system/files/documents/2023-06/life-cycle-nutrient-removal-2023-update.pdf) conducted for EPA’s Office of Water.
    ...
    - 5-Stage bardenpho, Level 3-1
    - Modified University of Cape Town, Level 3-2
    - 5-Stage bardenpho system with denitrification filter, Level 4-1
    - 4-Stage bardenpho membrane bioreactor, Level 4-2
    - 5-Stage bardenpho with sidestream reverse osmosis, Level 5-1
    - 5-Stage bardenpho membrane bioreactor with sidestream reverse osmosis, Level 5-2
- Updated PVC, EDC-VCM, chlorine, sodium hydroxide, and hydrogen processes based on new data from the Vinyl Institute and Sustainable Solutions Corporation. Removed the sodium hydroxide and hydrogen electrolysis processes and combined them with the chlorine electrolysis process using mass allocation.
- Added lithium hydroxide monohydrate production from pre-treated lithium brine and lithium hydroxide monohydrate production from spodumene concentrate (six processes total) from Natural Resources Canada and Argonne National Laboratory.
    - Lithium hydroxide monohydrate; production from pre-treated lithium brine
    - Pre-treated lithium brine
    - Lithium brine; extraction and reinjection
